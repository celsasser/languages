...
**Lifetime bounds: `'b: 'a` means `'b` outlives `'a`**
```rust
...
**Lifetime elision: when the compiler infers lifetimes**
...
**Algebraic data types (with data):**
...
### The Philosophy: Errors Are Just Data
