...
See [Common Programming Concepts](https://doc.rust-lang.org/book/ch03-00-common-programming-concepts.html) in *The Rust Programming Language* for more information.
...
See [Macros](https://doc.rust-lang.org/book/ch20-05-macros.html) in *The Rust Programming Language* for more information.
...
See [Validating References with Lifetimes](https://doc.rust-lang.org/book/ch10-03-lifetime-syntax.html) in *The Rust Programming Language* for more information.
...
See [Smart Pointers](https://doc.rust-lang.org/book/ch15-00-smart-pointers.html) in *The Rust Programming Language* for more information.
...
See [Enums and Pattern Matching](https://doc.rust-lang.org/book/ch06-00-enums.html) in *The Rust Programming Language* for more information.
...
See [Structs](https://doc.rust-lang.org/book/ch05-00-structs.html) in *The Rust Programming Language* for more information.
...
See [Generic Types, Traits, and Lifetimes](https://doc.rust-lang.org/book/ch10-00-generics.html) in *The Rust Programming Language* for more information.
...
See [Pattern Matching](https://doc.rust-lang.org/book/ch19-00-patterns.html) in *The Rust Programming Language* for more information.
...
See [Closures](https://doc.rust-lang.org/book/ch13-01-closures.html) in *The Rust Programming Language* for more information.
...
See [Iterators](https://doc.rust-lang.org/book/ch13-02-iterators.html) in *The Rust Programming Language* for more information.
...
See [Error Handling](https://doc.rust-lang.org/book/ch09-00-error-handling.html) in *The Rust Programming Language* for more information.
...
See [Common Collections](https://doc.rust-lang.org/book/ch08-00-common-collections.html) in *The Rust Programming Language* for more information.
...
See [Reading a File](https://doc.rust-lang.org/book/ch12-02-reading-a-file.html) and the [`std::io` module documentation](https://doc.rust-lang.org/std/io/index.html) for more information.
...
Cargo uses [semantic versioning](https://semver.org). The version string in `Cargo.toml` is a *requirement*, not an exact pin. Cargo selects the newest version that satisfies all constraints in the dependency graph:
...
See [Packages, Crates, and Modules](https://doc.rust-lang.org/book/ch07-00-managing-growing-projects-with-packages-crates-and-modules.html) in *The Rust Programming Language* for more information.
...
[clap](https://docs.rs/clap/latest/clap/) (Command Line Argument Parser) turns a Rust struct into a fully-featured CLI: `--help`, `--version`, validation, subcommands, and shell completions all come for free. You describe what your program accepts; clap handles the rest.
...
| `env = "MY_VAR"`           | Fall back to an [environment variable](https://doc.rust-lang.org/cargo/reference/environment-variables.html) if the flag is absent  |
...
See [clap documentation](https://docs.rs/clap/latest/clap/) and the [clap derive reference](https://docs.rs/clap/latest/clap/_derive/index.html) for the full attribute catalog.
...
- [Rust by Example](https://doc.rust-lang.org/rust-by-example/) is terse.
- [The Cargo Book](https://doc.rust-lang.org/cargo/) Cargo inside out.
