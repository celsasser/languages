...
## Cheat Sheet
I looked over here, and I looked over there. Then I found the cheat sheet I was looking for. He's all squished together and highly 2 dimensional. I edited him a little to get him to fit on a single page, but otherwise it's all [RefMint](https://refmint.com/topics/rust/).
...
The following example is taken out of our [exs24](https://github.com/celsasser/exs24-parser) parser:

```rust
let seconds: f32 = seconds_text
    .parse::<f32>()
    .map_err(|error| format!("Invalid seconds value '{}': {}", value_text, error))?;
```
